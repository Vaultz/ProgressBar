  ...
  <body>
    ...
    <section class="container mainsection">
      <div class="progress progress2">
        <div class="determinate pb_2" style="width: 0%"></div>
      </div>
      <div class="buttonbox">
        <a class="waves-effect waves-light btn blue startbuttons startest2">Start</a>
        <a href="test2.php" class="waves-effect waves-light btn disabled stopbuttons stoptest2">Stop</a>

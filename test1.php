...
<html>
  ...
  <body>
    ...
    <section class="container mainsection">
      <div class="progress">
        <div class="determinate pb_1" style="width: 0%"></div>
      </div>
      <div class="buttonbox">
        <a class="waves-effect waves-light btn blue startbuttons startest1">Start</a>
        <a href="test1.php" class="waves-effect waves-light btn disabled stopbuttons stoptest1">Stop</a>
